function outputsub = readoutputsub2(txtiodir,iprint)
...
formatSpec = '%6s%4f%12f%2f%10s%10f%10f%10f%10f%10f%10f%10f%10f%10f%10f%10f%10f%10f%10f%10f%10f%[^\n\r]';

%% Open the text file.
filename = [txtiodir '\output.sub'];
