...
opts.Sheet = "Xiang_industry_sub_monthly_Cd";
opts.DataRange = "A2:AL26330";

% Specify column names and types
opts.VariableNames = ["FID", "FID_Xiang_", "Year", "Y1", "Y2", "Y3", "Y4", "Y5", "Y6", "Y7", "Y8", "Y9", "Y10", "Y11", "Y12", "gridid", "gridlat", "gridlng", "FID_Waters", "GRIDCODE", "Subbasin", "Area", "Slo1", "Len1", "Sll", "Csl", "Wid1", "Dep1", "Lat", "Long_", "Elev", "ElevMin", "ElevMax", "Bname", "Shape_Leng", "Shape_Area", "HydroID", "OutletID"];
opts.VariableTypes = ["double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "categorical", "double", "double", "double", "double"];
opts = setvaropts(opts, 34, "EmptyFieldRule", "auto");
