...
formatSpec = '%4f%8f%6f%13f%13f%13f%13f%13f%13f%13f%13f%13f%13f%13f%f%[^\n\r]';
...
outhmlsub = table(dataArray{1:end-1}, 'VariableNames', {'SUB','YEAR','MON','AREAkm2','HM_SURQkg','HM_LATkg','HM_PERCkg','HM_PLANTkg','LabHM_EROkg','NLabHM_EROkg','HM_ATMOkg','HM_WETHkg','HM_AGRkg','HM_INkg','HM_OUTkg'});
