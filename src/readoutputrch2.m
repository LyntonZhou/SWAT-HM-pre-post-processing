function outputrch = readoutputrch2(projdir,iprint,SubNo,Simlength)
...
formatSpec = '%5s%5f%9f%6f%13f%12f%12f%12f%12f%12f%12f%12f%[^\n\r]';
...
outputrch = outputrch(outputrch.MON<13,:);
if (height(outputrch)/SubNo - Simlength) == 1
    outputrch(end-SubNo+1:end,:)=[];
end
end
